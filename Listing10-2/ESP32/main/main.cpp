...
// Tested devices:
//                                      ADDRS   SDA     SCL
//     Espressif ESP32 DevKitC V4                21      22
//     Espressif ESP32-C3 DevKitC 02             18      19
//     Sparkfun ESP32 Thing Plus                 23      22
//     Adafruit Huzzah32 ESP32 Feather           23      22
             ...
             TaskHandle_t  give )
{
    ...
    {
        auto err = WriteToDAC( port, address, dacOut, take, give );
...
void app_main( void )
{
    ...
    //
    //  7. The CPU to pin the task to.
    
    auto result = xTaskCreatePinnedToCore(DACthread,
                                          "Triangle 2",
                                          2048, // Stack depth
                                          NULL,
                                          priority,
